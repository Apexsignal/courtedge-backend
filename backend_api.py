...
def debug_current_candidates(_: None = Depends(require_admin_key)) -> list[dict]:
    ...
    blízko dnešní kandidáti byli k novému prahu 0,65 (nebo appka nemá
    nic ani na starém 0,60). Smaže se hned po ověření."""
    ...
    for c in candidates:
        ...
        result.append({
            ...
            "tourney_name": m.get("tourney_name"), "selection": c.selection,
